...
const productData: Record<string, ProductData> = {
  ...
  "dicom-film-printer": {
    ...
    image: productDicom,
    description: "RadPing Printer is a kind of Thermal Imaging Printer which can output the image in DICOM format. It features low fog, high sharpness, and high max density for superior diagnostic image quality.",
    specs: [
      ["Geometrical", "320 DPI (20 pixel/mm)"],
      ["Film Throughput", "70 sheets/hour (14×17) | 90 sheets/hour (8×10)"],
      ["Resolution", "14 bit"],
      ["Film Supply Tray", "2 Supply trays, 100 sheets per tray"],
      ["Film Sizes", "8×10, 10×12, 11×14, 14×17 inch"],
      ["Film Type", "Medical Thermal Film"],
      ["Film Input Cassette", "Factory sealed input cassette"],
      ["Port", "10/100 Base T Ethernet (RJ-45)"],
      ["Interface", "DICOM 3.0"],
      ["Image Quality", "Built-in densitometer automatic calibration"],
      ["Image Control", "Contrast / Grayscale / Polar / Rotate / Saturation / Scale"],
      ["Control Panel", "LCD display – online, alarm, fault and state"],
      ["Key Switch", "Power Supply and Menu navigation button"],
      ["Processor", "Intel"],
      ["Power Requirements", "220V/22V AC / 50Hz / 600W"],
      ["Weight", "45 Kg"],
      ["Warranty", "2 Years Standard"],
    ],
    features: [
      "Low fog for cleaner output",
      "High sharpness for detailed diagnostics",
      "High max density for superior contrast",
      "Dry thermal printing – no chemicals required",
